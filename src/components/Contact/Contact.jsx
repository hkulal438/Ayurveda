...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="contact-bg-shape contact-bg-shape-one"
        aria-hidden="true"
      />

      <div
        className="contact-bg-shape contact-bg-shape-two"
        aria-hidden="true"
      />

      <div
        className="contact-bg-leaf contact-leaf-one"
        aria-hidden="true"
      >
        ❧
      </div>
      ...
      <div
        className="contact-bg-leaf contact-leaf-two"
        aria-hidden="true"
      >
        ❧
      </div>
      ...
      <div className="contact-container">
        ...
        <div className="contact-info-card">
          ...
          <div
            className="contact-info-decoration"
            aria-hidden="true"
          />
